...
class VideoEnhancementApp:
    ...
    def __init__(self, root):
        ...
        self.SR_model_cb = tk.Checkbutton(cb_frame1, text="SR (Model)", variable=self.SR_model_var, font=self.my_font, fg="dark red")
        ...
        self.color_enhancement_cb.pack(side=tk.LEFT, padx=20)

        # Add object tracking checkbox
        self.object_tracking_var = tk.BooleanVar()
        self.object_tracking_cb = tk.Checkbutton(cb_frame1, text="Tracking (CV)", variable=self.object_tracking_var, font=self.my_font, fg="dark red")
        self.object_tracking_cb.pack(side=tk.LEFT, padx=20)
        
        # Add yolo detection
        self.object_yolo_var = tk.BooleanVar()
        self.object_yolo_cb = tk.Checkbutton(cb_frame1, text="Tracking (Yolo)", variable=self.object_yolo_var, font=self.my_font, fg="dark red")
        ...
        # Add yolo detection
        self.fire_yolo_var = tk.BooleanVar()
        self.fire_yolo_cb = tk.Checkbutton(cb_frame1, text="Fire Detection", variable=self.fire_yolo_var, font=self.my_font, fg="dark red")
        self.fire_yolo_cb.pack(side=tk.LEFT, padx=20)
        if not fire_model_loaded:
            print("Fire Yolo not loaded")
            self.fire_yolo_cb.config(state=tk.DISABLED)

        self.ppe_yolo_var = tk.BooleanVar()
        self.ppe_yolo_cb = tk.Checkbutton(cb_frame1, text="PPE", variable=self.ppe_yolo_var, font=self.my_font, fg="dark red")
        self.ppe_yolo_cb.pack(side=tk.LEFT, padx=20)
        if not ppe_model_loaded:
            print("PPE Yolo not loaded")
            self.ppe_yolo_cb.config(state=tk.DISABLED)
        ...
        self.sharpen_type1_cb.pack(side=tk.LEFT, padx=15)
        ...
        self.sharpen_type2_cb.pack(side=tk.LEFT, padx=15)
        ...
        self.sharpen_type3_cb.pack(side=tk.LEFT, padx=15)
        ...
        self.sharpen_type4_cb.pack(side=tk.LEFT, padx=15)
        ...
        self.sharpen_type5_cb.pack(side=tk.LEFT, padx=15)

        # Add Histogram Equalization Checkbox
        self.histogram_equalization_var = tk.BooleanVar()
        self.histogram_equalization_cb = tk.Checkbutton(cb_frame2, text="Histogram Equ.",
                                                        variable=self.histogram_equalization_var, font=self.my_font)
        self.histogram_equalization_cb.pack(side=tk.LEFT, padx=10)
    ...
    def enhance_frame(self, frame):
        ...
        if self.fire_yolo_var.get() and fire_model_loaded:
            enhanced = self.fire_detector.detect_and_draw(enhanced)
        
        # ppe model detection
        if self.ppe_yolo_var.get() and ppe_model_loaded:
            img_raw, enhanced, detections = detect_ppe(enhanced)
